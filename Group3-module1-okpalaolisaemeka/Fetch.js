...
function appendData(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    var div = document.createElement("div");
    div.innerHTML = " <div> Name: " + data[i].name + "</div>" + " <div> Email: " + data[i].email + 
    "</div>" + " <div> username: " + data[i].username + "</div>" + " <div> phone: " + data[i].phone + 
    "</div>" + " <div> website: " + data[i].website + "</div>" + " <div> id: " + data[i].id + "</div>";
